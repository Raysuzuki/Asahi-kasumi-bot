/*
Ga Usah Hapus Thanks To Lu Itu Cuma Numpang
Kasih Nama Lu Aja Di Bawah Thanks To Lain
Kalo Mau Reupload Izin Dlu Ke Wa
wa.me/6285642423940
...
Kalo Ada Yang Error Benerin Sendiri
Gua Cuma Newbie 🗿
*/
const {
    WAConnection,
...
fake = `Asahi Kasumi bot` 
footerr = `Asahi Kasumi bot` 
banChats = true
...
module.exports = client = async (client, mek) => {
	try {
        ...
        const ftroli = { 
            key: { fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "6289523258649-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: fakeimage, surface: 200, message: fake, orderTitle: 'zeeoneofc', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}                                                                        
        const fakecell = (teks) => { 
...
[
{buttonId:`${prefix}owner`,buttonText:{displayText:'Owner Contact'},type:1},

{buttonId:`${prefix}infobot`,buttonText:{displayText:'Infomation Bot'},type:1}
], 
...
//------------------< Ingfo Bot >-------------------
      ...
      case 'sc':
      case 'sourcecode':
              textImg(`https://github.com/Raysuzuki/Asahi-kasumi-bot`)
              break        
      case 'donate': 
      case 'donasi':
              textImg(`Mau donasi ya?? tinggal chat owner🗿`)
              break
      case 'ping':
      case 'speed':
              timestampe = speed();
...
//------------------< Owner >-------------------
      ...
      case 'broadcast':
             ...
             for (let _ of anu) {
             client.sendMessage(_.jid, bc, image, {quoted:freply,caption: `*「 BROADCAST ASAHI KASUMI BOT 」*\n\n${body.slice(4)}`})
}
             reply('Suksess broadcast')
             } else {
             for (let _ of anu) {
             sendMess(_.jid, `*「 BROADCAST ASAHI KASUMI BOT 」*\n\n${body.slice(4)}`)
}
             reply('Suksess broadcast')
}
             break
...
//------------------< Lainnya >-------------------
        ...
        case 'delete': // MR.CYSER
               ...
               break
        case 'tes':
               reply('𝙃𝙖𝙞𝙠 𝘼𝙨𝙖𝙝𝙞 𝘽𝙊𝙏 𝘼𝙆𝙏𝙄𝙁 𝙎𝙄𝙇𝘼𝙆𝘼𝙉 𝙆𝙀𝙏𝙄𝙆 ${prefix}menu.(｡•̀ᴗ-)✧')
               break
      case 'get':
      case 'fetch': 
